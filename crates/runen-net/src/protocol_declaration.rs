use crate::protocol::{
    ...
    ProtocolRevision, RequirementLevel, SchemaContractId, SchemaContractOffer, SchemaId, SchemaOffer,
};
...
impl SchemaOfferBuilder {
    pub fn new(id: SchemaId, requirement: RequirementLevel) -> Self {
        Self {
...
impl SchemaContractOfferBuilder {
    pub fn new(contract_id: SchemaContractId) -> Self {
        Self {
...
mod tests {
    ...
    fn builders_preserve_the_exact_manual_offer_value_and_order() {
        ...
        let capability_required = CapabilityOffer::new(
            CapabilityId::new(30),
            RequirementLevel::Required,
        );
        let capability_optional = CapabilityOffer::new(
            CapabilityId::new(31),
        ...
        let contract_b = SchemaContractOffer::new(
            SchemaContractId::new(51),
            vec![CodecId::new(62)],
        );
        let schema = SchemaOffer::new(
            SchemaId::new(40),
            RequirementLevel::Required,
        ...
        let empty = CompatibilityOffer::builder()
            ...
            .schema(
                SchemaOffer::builder(SchemaId::new(3), RequirementLevel::Required)
                    .contract(
                        SchemaContractOffer::builder(SchemaContractId::new(4)).build(),
                    )
                    .build(),
            )
            .build();
